...
import proyecto2_edd.EDD.Ordenamientos.HiloBurbuja;
...
public class OrdenamientoBurbuja extends javax.swing.JFrame {
    ...
    /**
     * Creates new form OrdenamientoBurbuja
     */
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("El método de ordenación por inserción directa \nconsiste en recorrer todo el array comenzando\n desde el segundo elemento hasta el final.\n Para cada elemento, se trata de colocarlo en el \nlugar correcto entre todos los elementos \nanteriores a él o sea entre los elementos a su \nizquierda en el array.\nDada una posición actual p, el algoritmo\n se basa en que los elementos \nA[0], A[1], ..., A[p-1] ya están ordenados.\n"); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        if (sig <= bb.imgNum - 1) {
            Image imgArbol = new ImageIcon("bb" + sig + ".png").getImage();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Thread hiloAV = new HiloBurbuja(bb.imgNum, jLabel1);
        hiloAV.start();
